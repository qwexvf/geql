...
-type occurs(IFE) :: {one, integer(), list(IFE), list(IFE)} |
    {other, integer(), list(IFE), list(IFE)} |
    {both, integer(), list(IFE), list(IFE), list(IFE), list(IFE)}.
...
?DOC(false).
-spec sum_occurrences(occurs(IGL), occurs(IGL)) -> occurs(IGL).
...
?DOC(false).
-spec histogram_add(
    gleam@dict:dict(IFZ, occurs(IFZ)),
    list(IFZ),
    fun((integer(), list(IFZ), list(IFZ)) -> occurs(IFZ)),
    list(IFZ)
) -> gleam@dict:dict(IFZ, occurs(IFZ)).
...
?DOC(false).
-spec lowest_occurrence_common_item(list(IFR), list(IFR)) -> gleam@option:option({IFR,
    integer(),
    list(IFR),
    list(IFR),
    list(IFR),
...
?DOC(false).
-spec do_pop_common_prefix(list(IGV), list(IGV), list(IGV)) -> {list(IGV),
    list(IGV),
    list(IGV)}.
...
?DOC(false).
-spec pop_common_prefix(list(IGP), list(IGP)) -> {list(IGP),
    list(IGP),
    list(IGP)}.
...
?DOC(false).
-spec pop_common_suffix(list(IHC), list(IHC)) -> {list(IHC),
    list(IHC),
    list(IHC)}.
...
?DOC(false).
-spec lcs(list(IFN), list(IFN)) -> list(IFN).
lcs(One, Other) ->
