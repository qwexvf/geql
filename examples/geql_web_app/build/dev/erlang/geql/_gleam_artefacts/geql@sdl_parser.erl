-module(geql@sdl_parser).
-compile([no_auto_import, nowarn_unused_vars, nowarn_unused_function, nowarn_nomatch]).
-define(FILEPATH, "src/geql/sdl_parser.gleam").
-export([parse_sdl/1]).
...
-type s_d_l_parse_error() :: {s_d_l_lex_error,
        geql@sdl_lexer:s_d_l_lexer_error()} |
    {unexpected_token,
        binary(),
        geql@sdl_lexer:s_d_l_token(),
        geql@sdl_lexer:position()} |
    {unexpected_e_o_f, binary()} |
    {invalid_type_definition, binary(), geql@sdl_lexer:position()}.

-type s_d_l_parser() :: {s_d_l_parser,
        list(geql@sdl_lexer:s_d_l_token_with_position()),
        integer()}.

-file("src/geql/sdl_parser.gleam", 668).
-spec get_token_at_helper(
    list(geql@sdl_lexer:s_d_l_token_with_position()),
    integer(),
    integer()
) -> {ok, geql@sdl_lexer:s_d_l_token_with_position()} | {error, nil}.
...
-file("src/geql/sdl_parser.gleam", 661).
-spec get_token_at(list(geql@sdl_lexer:s_d_l_token_with_position()), integer()) -> {ok,
        geql@sdl_lexer:s_d_l_token_with_position()} |
    {error, nil}.
get_token_at(Tokens, Target_index) ->
    get_token_at_helper(Tokens, Target_index, 0).

-file("src/geql/sdl_parser.gleam", 632).
...
-file("src/geql/sdl_parser.gleam", 636).
-spec consume_token(s_d_l_parser()) -> {ok,
        {geql@sdl_lexer:s_d_l_token_with_position(), s_d_l_parser()}} |
    {error, nil}.
...
-file("src/geql/sdl_parser.gleam", 252).
...
-file("src/geql/sdl_parser.gleam", 277).
...
-file("src/geql/sdl_parser.gleam", 262).
...
-file("src/geql/sdl_parser.gleam", 475).
-spec parse_value(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:s_d_l_value(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
parse_value(Parser) ->
    case peek_token(Parser) of
...
-file("src/geql/sdl_parser.gleam", 460).
-spec parse_optional_default_value(s_d_l_parser()) -> {ok,
        {gleam@option:option(geql@sdl_ast:s_d_l_value()), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 527).
...
-file("src/geql/sdl_parser.gleam", 520).
...
-file("src/geql/sdl_parser.gleam", 571).
-spec parse_enum_value_definition(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:enum_value_def(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 552).
-spec parse_enum_values(s_d_l_parser(), list(geql@sdl_ast:enum_value_def())) -> {ok,
        {list(geql@sdl_ast:enum_value_def()), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 646).
-spec expect_token(s_d_l_parser(), geql@sdl_lexer:s_d_l_token(), binary()) -> {ok,
        {geql@sdl_lexer:s_d_l_token_with_position(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 196).
?DOC(" Parse: scalar DateTime\n").
-spec parse_scalar_type_definition(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:scalar_type_def(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 343).
-spec parse_type(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:s_d_l_type(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
parse_type(Parser) ->
    case peek_token(Parser) of
...
-file("src/geql/sdl_parser.gleam", 438).
-spec parse_argument_definition(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:argument_def(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 421).
-spec parse_argument_definitions(
    s_d_l_parser(),
    list(geql@sdl_ast:argument_def())
) -> {ok, {list(geql@sdl_ast:argument_def()), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 399).
-spec parse_optional_arguments_definition(s_d_l_parser()) -> {ok,
        {list(geql@sdl_ast:argument_def()), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 321).
-spec parse_field_definition(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:field_def(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 304).
-spec parse_field_definitions(s_d_l_parser(), list(geql@sdl_ast:field_def())) -> {ok,
        {list(geql@sdl_ast:field_def()), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 295).
...
-file("src/geql/sdl_parser.gleam", 123).
?DOC(" Parse: type User { ... }\n").
-spec parse_object_type_definition(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:object_type_def(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 153).
?DOC(" Parse: interface Node { ... }\n").
-spec parse_interface_type_definition(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:interface_type_def(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 543).
...
-file("src/geql/sdl_parser.gleam", 608).
-spec parse_input_field_definition(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:input_field_def(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 591).
-spec parse_input_fields(s_d_l_parser(), list(geql@sdl_ast:input_field_def())) -> {ok,
        {list(geql@sdl_ast:input_field_def()), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 582).
...
-file("src/geql/sdl_parser.gleam", 57).
-spec parse_type_system_definition(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:type_system_definition(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 40).
-spec parse_definitions(
    s_d_l_parser(),
    list(geql@sdl_ast:type_system_definition())
) -> {ok, {list(geql@sdl_ast:type_system_definition()), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 33).
-spec parse_document(s_d_l_parser()) -> {ok,
        {geql@sdl_ast:s_d_l_document(), s_d_l_parser()}} |
    {error, s_d_l_parse_error()}.
...
-file("src/geql/sdl_parser.gleam", 24).
?DOC(" Parse SDL string into an AST\n").
-spec parse_sdl(binary()) -> {ok, geql@sdl_ast:s_d_l_document()} |
    {error, s_d_l_parse_error()}.
parse_sdl(Input) ->
    gleam@result:'try'(
        begin
            _pipe = geql@sdl_lexer:tokenize_sdl(Input),
            gleam@result:map_error(
                _pipe,
