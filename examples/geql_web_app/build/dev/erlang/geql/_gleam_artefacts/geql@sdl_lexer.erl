-module(geql@sdl_lexer).
-compile([no_auto_import, nowarn_unused_vars, nowarn_unused_function, nowarn_nomatch]).
-define(FILEPATH, "src/geql/sdl_lexer.gleam").
...
-file("src/geql/sdl_lexer.gleam", 349).
...
-file("src/geql/sdl_lexer.gleam", 204).
...
-file("src/geql/sdl_lexer.gleam", 371).
...
-file("src/geql/sdl_lexer.gleam", 429).
...
-file("src/geql/sdl_lexer.gleam", 212).
...
-file("src/geql/sdl_lexer.gleam", 436).
...
-file("src/geql/sdl_lexer.gleam", 256).
...
-file("src/geql/sdl_lexer.gleam", 449).
...
-file("src/geql/sdl_lexer.gleam", 276).
...
-file("src/geql/sdl_lexer.gleam", 464).
...
-file("src/geql/sdl_lexer.gleam", 299).
...
-file("src/geql/sdl_lexer.gleam", 475).
...
-file("src/geql/sdl_lexer.gleam", 309).
...
-file("src/geql/sdl_lexer.gleam", 97).
...
-file("src/geql/sdl_lexer.gleam", 81).
...
-file("src/geql/sdl_lexer.gleam", 74).
