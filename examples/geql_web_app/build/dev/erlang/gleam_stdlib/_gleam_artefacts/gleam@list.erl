...
-file("src/gleam/list.gleam", 1014).
?DOC(
...
-file("src/gleam/list.gleam", 1052).
?DOC(
...
-file("src/gleam/list.gleam", 1124).
?DOC(
...
-file("src/gleam/list.gleam", 1156).
?DOC(
...
-file("src/gleam/list.gleam", 1272).
?DOC(
...
-file("src/gleam/list.gleam", 1373).
?DOC(
...
-file("src/gleam/list.gleam", 1447).
?DOC(
...
-file("src/gleam/list.gleam", 1339).
?DOC(
...
-file("src/gleam/list.gleam", 1487).
...
-file("src/gleam/list.gleam", 1483).
?DOC(
...
-file("src/gleam/list.gleam", 1509).
?DOC(
...
-file("src/gleam/list.gleam", 1542).
?DOC(
...
-file("src/gleam/list.gleam", 1575).
?DOC(
...
-file("src/gleam/list.gleam", 1622).
?DOC(
...
-file("src/gleam/list.gleam", 1653).
?DOC(
...
-file("src/gleam/list.gleam", 1689).
?DOC(
    " Given a list of 2-element tuples, finds the first tuple that has a given\n"
...
-file("src/gleam/list.gleam", 1723).
?DOC(
...
-file("src/gleam/list.gleam", 1755).
?DOC(
...
-file("src/gleam/list.gleam", 1834).
?DOC(
...
-file("src/gleam/list.gleam", 2013).
?DOC(
...
-file("src/gleam/list.gleam", 2061).
?DOC(
...
-file("src/gleam/list.gleam", 2077).
?DOC(
...
-file("src/gleam/list.gleam", 2118).
?DOC(
...
-file("src/gleam/list.gleam", 2203).
?DOC(
...
-file("src/gleam/list.gleam", 2185).
?DOC(
...
-file("src/gleam/list.gleam", 2283).
?DOC(
...
-file("src/gleam/list.gleam", 2370).
?DOC(
...
-file("src/gleam/list.gleam", 2317).
?DOC(
